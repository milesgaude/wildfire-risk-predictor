...
# State coordinates for auto-filling lat/long
state_coords = {
...
with col1:
    ...
    st.caption("Coordinates auto-filled from state — adjust for a specific area")
...
day_of_year = int((month - 1) * 30.44 + 15)  # middle of selected month
fire_year = 2015  # use most recent year in training data
